...
disp('-----------------------')
disp('EXPERIMENT 2-2 INDIVIDUAL REWARD IN THE CONSERVATIVE SCENARIO (with alternative CCA levels)')
disp('-----------------------')
...
% Save Workspace
save(['./Output/EXPERIMENT_2_2' endTextOutputFile '_workspace.mat'])